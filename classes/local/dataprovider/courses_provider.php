...
/**
 * Implementation of the courses provider interface using certain API.
 *
...
final class courses_provider implements courses_provider_interface {
    ...
    public function fetch_courses(): array {
        ...
        $courses = [];
        foreach ($result as $courseasarray) {
            $courses[] = course::create_from_array($courseasarray);
        }
